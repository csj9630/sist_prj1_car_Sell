...
//   -sme : SettlementEvt
   ...
   public JTable monthlyTable() {
      String[] columnNames = { "월별", "총 판매 금액", "총 세금", "총 정산 금액", "전월 대비 실적 증감율" };
      ...
      String[] tempArr = { "1월", "30,000,000 원", "3,000,000 원", "27,000,000 원", "0 %" };
      dtmMonthlyInfo.addRow(tempArr);
      String[] tempArr2 = { "2월", "50,000,000 원", "5,000,000 원", "45,000,000 원", "+20 %" };
      dtmMonthlyInfo.addRow(tempArr2);
...
//      String[] tempArr = { "하나", "둘", "셋", "넷", "다섯", "여섯", "일곱" };
//      for (int i = 0; i < 3; i++) {
//         dtmSettlementInfot.addRow(tempArr);
//      } // end for
...
//        }
      ...
      // 분기별 판매 현황
      String[] QuarterlyArr = { "분기별 판매현황", "1분기", "2분기", "3분기", "4분기", "1년" }; // ⬅️ "월별 판매 현황" 추가
      ...
      String[] deleveryStateArr = { "탁송 상태", "탁송 준비", "탁송 중", "탁송 완료","배송중" };
