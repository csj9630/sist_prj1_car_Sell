...
import kr.co.sist.car_sell.dto.OrderListManagerDTO;
import kr.co.sist.car_sell.event.OrderListManagerEvent;
import kr.co.sist.car_sell.service.OrderListManagerService;
	...
	public OrderListManagerDesign() {
		...
		if(orders==null || orders.isEmpty()) {
			...
			for(OrderListManagerDTO olmDTO:orders) {
				...
				rowData[5]=String.format("%,d", olmDTO.getPrice())+"만 원";
