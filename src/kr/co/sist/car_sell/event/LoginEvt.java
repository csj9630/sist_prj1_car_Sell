package kr.co.sist.car_sell.event; // 패키지명 확인
...
import kr.co.sist.car_sell.design.LoginDesign;
import kr.co.sist.car_sell.design.MgrMenuDesign;
import kr.co.sist.car_sell.design.RegisterDesign;
...
//					new CarListDesign(); // 차량 리스트 디자인 화면 실행
					new CarListDesign("u" ,uDTO.getUser_code()); // 차량 리스트 디자인 화면 실행
